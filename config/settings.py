...
SECRET_KEY = 'django-insecure-3_v=mt#y=o#km6)g381e3#-7leftn7=wets^h)9u&9$_&us+-s'
...
EMAIL_RECEPIENTS = ['guldmytro@gmail.com',]
# Parler settings
PARLER_LANGUAGES = {
    None: (
        {'code': 'uk'},
...
DJOSER = {
    'ACTIVATION_URL': 'uk/api/v1/activate-user/{uid}/{token}',
...
LOGGING = {
    ...
    "handlers": {
        "file": {
            ...
            "filename": os.path.join(BASE_DIR, "logs/liqpay.log"),
            "formatter": "verbose",
        },
        "console": {
            "level": "DEBUG",
